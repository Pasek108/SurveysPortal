                            ...
                            <thead>
                                <tr class="text-left text-white divide-x bg-slate-800">
                                    ...
                                    <th class="px-4 py-2 whitespace-nowrap">
                                        ...
                                        @elseif ((empty(request()->sort) || request()->sort == 'title') && (empty(request()->order) || request()->order == 'ASC'))
                                    ...
                                    <th class="px-4 py-2 whitespace-nowrap">
                                        ...
                                        @elseif ((empty(request()->sort) || request()->sort == 'owner') && (empty(request()->order) || request()->order == 'ASC'))
                                    ...
                                    <th class="px-4 py-2 whitespace-nowrap">
                                        ...
                                        @elseif ((empty(request()->sort) || request()->sort == 'start_date') && (empty(request()->order) || request()->order == 'ASC'))
                                    ...
                                    <th class="px-4 py-2 whitespace-nowrap">
                                        ...
                                        @elseif ((empty(request()->sort) || request()->sort == 'end_date') && (empty(request()->order) || request()->order == 'ASC'))
